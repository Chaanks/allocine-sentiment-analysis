...
"""cnn_expanded.py: Defines a better version of a CNN for our sentiment analysis application."""
...
class CNNExpanded(tf.keras.Model):
    def __init__(
        self,
        out_dim: int,
        voc_len: int,
        ...
        super(CNNExpanded, self).__init__()
